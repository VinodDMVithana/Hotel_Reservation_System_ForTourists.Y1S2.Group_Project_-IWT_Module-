        ...
        <ul>
            ...
            <?php if (isset($_COOKIE['user'])) : ?>
                ...
                <?php elseif (json_decode($_COOKIE['user'])->usertype == "2") : ?>
                    ...
                    <li><a href="../UserManagement/ViewAllUser.php">All Users</a></li>
                    <li><a href="./ViewAllFeedback.php">All Feedback</a></li>
                <?php endif; ?>
                <li><a href="#" onclick="logout()">Log out</a></li>
            <?php else : ?>
                <li><a href="../UserManagement/register.php">Sign Up</a></li>
                <li><a href="../UserManagement/login.php">Log in</a></li>
            <?php endif; ?>
